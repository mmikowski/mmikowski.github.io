...
new or revolutionary. You will see echoes of SOAP, JSON RPC, JSON API, JSend, JSON LD
...
Here is are the recommended action verbs for Requests, Responses,
and Confirmations:
...
The JSON below shows all available log levels.
...
transaction specific fields.  Here it is again:
