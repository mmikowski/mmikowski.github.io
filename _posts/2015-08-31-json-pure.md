...
they are almost always the best choice for internet APIs.  In truth, they 
...
**JSON-Pure APIs** - a name we **made up** simply for _brevity and convenience_ - 
follow these conventions.  And no, there isn't an official standard 
or an Internet Engineering Task Force project.  At least not yet ;)
...
revolutionary. You will see echoes of SOAP, JSON RPC, JSON API, JSON LD
and Hydra in the recommendations - and probably a few other dozen
standards we somehow missed.

Sometimes putting all recommendations in one place provides lots of value.
...
with little nuance. This greatly reduces the cognitive overhead
