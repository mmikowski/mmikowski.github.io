...
#### REST is good
**REST** is going to be around for a long time because.  It works very well for
...
can't uncook an egg, and this title misled many people to think the article was
condeming all of **REST**.

So let me be clear, **REST** is good. **RESTful APIs** on the other hand, not so much.
