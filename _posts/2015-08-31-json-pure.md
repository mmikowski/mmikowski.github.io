...
Server action verbs UPPERCASE to help differentiate them. Response verbs are directly correlated with request verbs.  While at first glance this may appear almost trite, it actually is quite important and useful, as we shall see when we discuss *indirect responses* below.
